...
SYSTEMD_SERVICE:${PN}:append:ast2700-default = "${@bb.utils.contains('ENABLE_MCTP_KERNEL_MODE', '1', 'mctp-kernel-ctrl.service', 'mctp-i2c8-ctrl.service mctp-i2c8-demux.service mctp-i2c8-demux.socket', d)}"
