...
SYSTEMD_SERVICE:${PN}:remove:ast2700-default = " mctp-spi-demux.socket "
SYSTEMD_SERVICE:${PN}:remove:ast2700-default = " mctp-pcie-ctrl.service "
SYSTEMD_SERVICE:${PN}:remove:ast2700-default = " mctp-pcie-demux.service "
SYSTEMD_SERVICE:${PN}:remove:ast2700-default = " mctp-pcie-demux.socket "
SYSTEMD_SERVICE:${PN}:append:ast2700-default = " mctp-i2c8-ctrl.service"
SYSTEMD_SERVICE:${PN}:append:ast2700-default = " mctp-i2c8-demux.service"
SYSTEMD_SERVICE:${PN}:append:ast2700-default = " mctp-i2c8-demux.socket"

# setup required files for ast2700evb
do_install:append:ast2700-default() {
