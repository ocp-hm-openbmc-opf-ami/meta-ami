...
do_install:append() {
  install -m 0755 ${S}/obmc-init-ast2700.sh ${D}/init
  install -m 0755 ${S}/obmc-update-ast2700.sh ${D}/update
  install -m 0644 ${S}/init-options ${D}/init-options
}
...
do_install:append:ast2700-abr() {
  install -m 0755 ${S}/obmc-init-ast2700-ABR.sh ${D}/init
  install -m 0755 ${S}/obmc-update-ast2700-ABR.sh ${D}/update
}
