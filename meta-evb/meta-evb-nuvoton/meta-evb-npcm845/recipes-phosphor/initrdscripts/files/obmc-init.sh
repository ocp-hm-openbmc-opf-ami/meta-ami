...
# NPCM845: Always use RAM-backed overlay upper so nv-syncd can safely
# mount the JFFS2 rwfs partition separately at /tmp/.rwfs and sync
# RAM -> flash.  Without this, flashcp during fw-update would corrupt
# the live overlay upper.
rwfst=none
