#!/bin/sh
	...
	sed -i 's/github.com\/ocp-hm-openbmc-opf-ami\/host-error-monitor;branch=master;protocol=https;name=override/git.ami.com\/core\/ami-bmc\/one-tree\/core\/host-error-monitor.git;branch=master;protocol=https;name=override/g' meta-ami/meta-common/recipes-ami/libpdkhook/libpdkhook_git.bb
