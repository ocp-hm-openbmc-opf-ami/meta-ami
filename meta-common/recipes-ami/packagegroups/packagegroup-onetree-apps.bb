...
PACKAGES = "\
        ...
        ${@bb.utils.contains('IMAGE_FEATURES', 'onetree-rpc', '${PN}-rpc', '', d)} \
...
SUMMARY:${PN}-cxl-mgmt = "EP : CXL"
DESCRIPTION:${PN}-cxl-mgmt = "Manage the CXL by way of MCTP over SMBus and MCTP over PCIe "
RDEPENDS:${PN}-cxl-mgmt = "	cxl-mgmt  "
SUPPORTED_VENDOR:${PN}-cxl-mgmt = "ALL"
#-----------------------------------#
...
RDEPENDS:${PN}-network-openssl-support = " openssl-manager fips-openssl "
...
RDEPENDS:${PN}-network-disable-ping-support = " phosphor-network iptables ${PN}-network-system-firewall-support"
...
SUMMARY:${PN}-rpc = "EP : Rack Power Controller"
DESCRIPTION:${PN}-rpc = "AMI Rack Power Controller"
RDEPENDS:${PN}-rpc = " enable-rackpowercontroller-support ${PN}-psm"
SUPPORTED_VENDOR:${PN}-rpc = "EVB"
#-----------------------------------#
...
SUMMARY:${PN}-phosphor-health-monitor = "AMI Core Features: Phosphor-Health-Monitor"
DESCRIPTION:${PN}-phosphor-health-monitor = " Enabled Phosphor-health-monitor"
RDEPENDS:${PN}-phosphor-health-monitor = " phosphor-health-monitor"
SUPPORTED_VENDOR:${PN}-phosphor-health-monitor = "ALL"
#-----------------------------------#

SUMMARY:${PN}-onetree-mac-eeprom-support = "AMI Core Features: reacd mac from eeprom features"
DESCRIPTION:${PN}-onetree-mac-eeprom-support = " Reads mac address from the peerom specified in the DTS "
