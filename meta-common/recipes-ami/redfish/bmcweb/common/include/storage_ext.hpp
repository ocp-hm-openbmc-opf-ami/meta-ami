    ...
    const std::string& systemName)
{
    ...
    collection::getCollectionMembers(
        ...
        interface, "/xyz/openbmc_project/inventory", systemName,
    ...
    const std::string& systemName, const std::string& storageId)
{
...
#ifdef ONETREE_BRCMRAID
    {
        ...
        if ((raid != std::string::npos) || (hba != std::string::npos))
        {
            redfish::getBRCMStorageInstance(asyncResp, systemName, storageId);
        }
    }
#endif
#ifdef ONETREE_BRCMRAID8
    {
        ...
        if (sl8 != std::string::npos)
        {
            redfish::getSl8StorageInstance(asyncResp, systemName, storageId);
        }
    }
#endif
#ifdef ONETREE_MSCCRAID
...
#ifdef ONETREE_RTP
    {
        ...
        {
            redfish::handleStorageRep(asyncResp, systemName, storageId);
            return;
        }
    }
#endif
