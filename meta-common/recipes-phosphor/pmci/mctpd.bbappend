...
SRC_URI = "git://git@github.com/ocp-hm-openbmc-opf-ami/firmware.bmc.openbmc.applications.mctpd.git;protocol=https;branch=openbmc/release/birchstream/common"
