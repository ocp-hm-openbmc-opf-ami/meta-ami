...
exclude_list=" nscd bmcweb phosphor-image-updater phosphor-version-software-manager memorycritical memorywarning phosphor-network-manager dbus-broker phosphor-health-monitor "
