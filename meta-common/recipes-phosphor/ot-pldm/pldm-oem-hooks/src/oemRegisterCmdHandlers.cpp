    ...
    OemCmdHandler()
    {
        handlers.emplace(
            ...
            [this](pldm_tid_t, const pldm_msg* request, size_t payloadLength) {
                // lg2::info(
                //     "[pldm-oem-hooks : PLDM_OEM_CMD_0x00]
                //     PLDM_OEM_TYPE_0x3E:{TYPE} PLDM_OEM_CMD_0x00:{CMD}
                //     payloadLength: {PL}", "TYPE", PLDM_OEM_TYPE_0x3E, "CMD",
                //     PLDM_OEM_CMD_0x00, "PL", payloadLength);
...
{
    // lg2::info(
    //     "[pldm-oem-hooks : oemRegisterCmdHandlers] PLDM_OEM_TYPE_0x3E={TYPE}
    //     PLDM_OEM_CMD_0x00={CMD}", "TYPE", PLDM_OEM_TYPE_0x3E, "CMD",
    //     PLDM_OEM_CMD_0x00);
    ...
    {
        // lg2::info(
        //     "[pldm-oem-hooks : oemRegisterCmdHandlers] Skip registering OEM
        //     command handler, already exists for type: {TYPE}", "TYPE",
        //     PLDM_OEM_TYPE_0x3E);
    }
    return 0;
}
